...
# cutadapt -a CGTCAAGA -A CCAGTGTT -o GBI_Adensiflora_S9_L001_R1_001_trimmed.fastq.gz  -p GBI_Adensiflora_S9_L001_R2_001_trimmed.fastq.gz GBI_Adensiflora_S9_L001_R1_001.fastq.gz GBI_Adensiflora_S9_L001_R2_001.fastq.gz
# cutadapt -a ATAGGTCC -A TGGTACAG -o GBI_Fstriata_S10_L001_R1_001_trimmed.fastq.gz -p GBI_Fstriata_S10_L001_R2_001_trimmed.fastq.gz GBI_Fstriata_S10_L001_R1_001.fastq.gz GBI_Fstriata_S10_L001_R2_001.fastq.gz
...
# zcat GBI_Fstriata_S4_L001_R1_001_trimmed.fastq.gz GBI_Fstriata_S10_L001_R1_001_trimmed.fastq.gz > GBI_Fstriata_S4_S10_L001_R1_001_trimmed.fastq.gz
# zcat GBI_Fstriata_S4_L001_R2_001_trimmed.fastq.gz GBI_Fstriata_S10_L001_R2_001_trimmed.fastq.gz > GBI_Fstriata_S4_S10_L001_R2_001_trimmed.fastq.gz
