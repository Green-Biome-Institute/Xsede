...
blastn -task blastn -num_descriptions 1 -num_alignments 1 -num_threads 120 -query GBI_Mabbottii_S5_L001_R1_001_100K.fasta -db /ocean/projects/bio210016p/shared/blast_databases/nt -out GBI_Mabbottii_S5_L001_R1_001_100K_blast.out
