...
sed -n '1~4s/^@/>/p;2~4p' GBI_Fstriata_S4_L001_R1_001_100K.fastq > GBI_Fstriata_S4_L001_R1_001_100K.fasta
...
blastn -task blastn -num_descriptions 1 -num_alignments 1 -num_threads 64 -query GBI_Fstriata_S4_L001_R1_001_100K.fasta -db /ocean/projects/bio210016p/shared/blast_databases/nt -out GBI_Fstriata_S4_L001_R1_001_100K_blast.out
# blastn -task blastn -num_descriptions 1 -num_alignments 1 -num_threads 128 -query GBI_Mabbottii_S5_L001_R1_001_100K.fastq -db /ocean/projects/bio210016p/shared/blast_databases/nt -out GBI_Mabbottii_S5_L001_R1_001_100K_blast.out
